...
def build_dataset(dataset_list, transforms, dataset_catalog, is_train=True, return_box_id=False, pseudo_weight=1):
    """
    Arguments:
    ...
    for dataset_name in dataset_list:
        ...
        if data["factory"] == "COCODataset":
            ...
            args["pseudo_weight"] = pseudo_weight
...
def make_data_loader(cfg, is_train=True, is_distributed=False, start_iter=0):
    ...
    datasets = build_dataset(dataset_list,
                             ...
                             DatasetCatalog,
                             is_train,
                             cfg.MODEL.EXTRACT_FEATURE,
                             cfg.MODEL.PSEUDO_WEIGHT)
